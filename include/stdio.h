...
// ) #define va_start(ap,v) ( ap = (va_list)&v + _INTSIZEOF(v) ) #define
// va_arg(ap,t)    ( *(t *)((ap += _INTSIZEOF(t)) - _INTSIZEOF(t)) ) #define
...
void vprintfmt(
    void (*putch)(int, void *), void *putdat, const char *fmt, va_list);
